...
Gemini 3 is Google's latest multimodal AI model featuring massive context window (1 million tokens), powerful multimodal understanding and generation capabilities, and action-oriented automation. It can process and generate text, images, audio, video, and code, and can directly generate websites with real-time preview.

### What is this repository?

This is a curated collection of creative prompts for Gemini 3, automatically synced with our CMS and featuring a beautiful web gallery at [youmind.com/gemini-3-prompts](https://youmind.com/gemini-3-prompts).

## Contributing

### How do I submit a prompt?

Use our [GitHub Issue template](https://github.com/YouMind-OpenLab/awesome-gemini-3-prompts/issues/new?template=submit-prompt.yml) to submit your prompt. Fill in all required fields and wait for team review.
...
Use our [Bug Report template](https://github.com/YouMind-OpenLab/awesome-gemini-3-prompts/issues/new?template=bug-report.yml).

### How do I contact the team?

- 📧 Email: contact@youmind.ai
- 💬 [GitHub Discussions](https://github.com/YouMind-OpenLab/awesome-gemini-3-prompts/discussions)
- 🐛 [GitHub Issues](https://github.com/YouMind-OpenLab/awesome-gemini-3-prompts/issues)

---

Don't see your question? Ask in [GitHub Discussions](https://github.com/YouMind-OpenLab/awesome-gemini-3-prompts/discussions)!
